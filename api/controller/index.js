...
routes.get('/booksa', (req, res)=>{
    bookauthors.fetchBooksA(req, res)
})
routes.get('/booka/:id', (req, res)=>{
    bookauthors.fetchBookA(req,res)
})
routes.post('/registerbooka', bodyParser.json(),(req, res)=>{
    bookauthors.resgisterBookA(req ,res)
})
routes.put('/booka/:id', bodyParser.json(),(req, res)=>{
    bookauthors.updateBooksA(req, res)
})
routes.patch('/booka/:id', bodyParser.json(),(req, res)=>{
    bookauthors.updateBooksA(req, res)
})
routes.delete('/booka/:id',(req ,res)=>{
